...
import { FaBars, FaMousePointer, FaGithub, FaLinkedin, FaTwitter, FaFacebookF } from 'react-icons/fa';
    ...
    <div className={`h-screen lg:p-[0.8rem] flex flex-col select-none font-circular`}>
      ...
      <div className='flex relative h-full justify-between gap-x-3'>
        ...
        <div className={`hidden lg:block absolute lg:w-20 lg:relative bg-DeepNightBlack shadow-2xl rounded-xl overflow-hidden`}>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 card_stylings text-xl w-[80%] py-8 sm:text-3xl flex flex-col gap-y-8 items-center justify-center text-Snow">
            ...
            <a className='hover:scale-125 ease-in-out duration-700 hidden sm:block' href={SOCIAL_LINKS.FACEBOOK} target='_blank' rel="noreferrer"><FaFacebookF /></a>
